...
-- Table `tfg`.`project`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tfg`.`project` (
...
-- -----------------------------------------------------
-- Table `tfg`.`projects_group`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tfg`.`projects_group` (
...
-- -----------------------------------------------------
-- Table `tfg`.`user_has_project`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tfg`.`user_has_project` (
  ...
  CONSTRAINT `fk_user_has_project_project1`
    ...
    REFERENCES `tfg`.`project` (`id_project`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `tfg`.`project_has_projects_group`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tfg`.`project_has_projects_group` (
  `project_id_fk` INT NOT NULL,
  ...
  CONSTRAINT `fk_project_has_projects_group_projects_group1`
    ...
    REFERENCES `tfg`.`projects_group` (`id_group`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
